...
public partial class @XRIDefaultInputActions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""PrimaryButton"",
                    ""type"": ""Button"",
                    ""id"": ""3f773448-350d-4353-82ad-ddd19177451e"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ...
                    ""type"": ""Button"",
                    ""id"": ""9736e4c6-17c2-4d04-8530-95bfa68239af"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""e2015b2d-2d88-4e97-87d7-74308aef3c33"",
                ...
                {
                    ""name"": """",
                    ""id"": ""1da30574-f472-4dba-903b-b9fda535d125"",
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""PrimaryButton"",
                    ""type"": ""Button"",
                    ""id"": ""01388c3b-1fc9-4480-90d6-8b9ad727bc9c"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""SecondaryButton"",
                    ""type"": ""Button"",
                    ""id"": ""0c913ea1-489c-44c1-9b2a-3ca204cbc77b"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""c4f62250-8ced-4021-9135-bda66a449ad9"",
                ...
                {
                    ""name"": """",
                    ""id"": ""e18329a2-1df4-4d53-b4cf-324c390af737"",
        ...
        {
            ""name"": ""XRI LeftHand Controller"",
            ""id"": ""369f8a23-650c-4f2d-a3fb-62a5d2789d31"",
            ""actions"": [
                {
                    ""name"": ""MenuButton"",
                    ""type"": ""Button"",
                    ""id"": ""c73a504d-7f00-4313-b7bc-c1080e80580e"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""c054ba2e-4fcd-4035-b7ca-0d87f57a80c3"",
    ...
    ""controlSchemes"": [
        ...
        // XRI LeftHand Controller
        m_XRILeftHandController = asset.FindActionMap("XRI LeftHand Controller", throwIfNotFound: true);
        m_XRILeftHandController_MenuButton = m_XRILeftHandController.FindAction("MenuButton", throwIfNotFound: true);
    }
    ...
    ~@XRIDefaultInputActions()
    {
        ...
        Debug.Assert(!m_XRILeftHandController.enabled, "This will cause a leak and performance issues, XRIDefaultInputActions.XRILeftHandController.Disable() has not been called.");
    }
    ...
    // XRI LeftHand Controller
    private readonly InputActionMap m_XRILeftHandController;
    private List<IXRILeftHandControllerActions> m_XRILeftHandControllerActionsCallbackInterfaces = new List<IXRILeftHandControllerActions>();
    private readonly InputAction m_XRILeftHandController_MenuButton;
    public struct XRILeftHandControllerActions
    {
        private @XRIDefaultInputActions m_Wrapper;
        public XRILeftHandControllerActions(@XRIDefaultInputActions wrapper) { m_Wrapper = wrapper; }
        public InputAction @MenuButton => m_Wrapper.m_XRILeftHandController_MenuButton;
        public InputActionMap Get() { return m_Wrapper.m_XRILeftHandController; }
        public void Enable() { Get().Enable(); }
        public void Disable() { Get().Disable(); }
        public bool enabled => Get().enabled;
        public static implicit operator InputActionMap(XRILeftHandControllerActions set) { return set.Get(); }
        public void AddCallbacks(IXRILeftHandControllerActions instance)
        {
            if (instance == null || m_Wrapper.m_XRILeftHandControllerActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_XRILeftHandControllerActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(IXRILeftHandControllerActions instance)
        {
            @MenuButton.started -= instance.OnMenuButton;
            @MenuButton.performed -= instance.OnMenuButton;
            @MenuButton.canceled -= instance.OnMenuButton;
        ...
        public void RemoveCallbacks(IXRILeftHandControllerActions instance)
        {
            if (m_Wrapper.m_XRILeftHandControllerActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IXRILeftHandControllerActions instance)
        {
            foreach (var item in m_Wrapper.m_XRILeftHandControllerActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_XRILeftHandControllerActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    public XRILeftHandControllerActions @XRILeftHandController => new XRILeftHandControllerActions(this);
    ...
    public interface IXRILeftHandControllerActions
    {
