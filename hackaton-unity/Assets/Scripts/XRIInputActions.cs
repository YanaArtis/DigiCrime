...
//     version 1.7.0
//     from Assets/Samples/XR Interaction Toolkit/2.5.3/Starter Assets/XRI Input Actions.inputactions
//
...
public partial class @XRIInputActions: IInputActionCollection2, IDisposable
{
    ...
    ""controlSchemes"": [
        ...
        m_XRILeftHandController_Newaction = m_XRILeftHandController.FindAction("New action", throwIfNotFound: true);
    }
    ...
    {
        private @XRIInputActions m_Wrapper;
        public XRIUIActions(@XRIInputActions wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @XRIInputActions m_Wrapper;
        public TouchscreenGesturesActions(@XRIInputActions wrapper) { m_Wrapper = wrapper; }
    ...
    private readonly InputAction m_XRILeftHandController_Newaction;
    public struct XRILeftHandControllerActions
    {
        private @XRIInputActions m_Wrapper;
        public XRILeftHandControllerActions(@XRIInputActions wrapper) { m_Wrapper = wrapper; }
        public InputAction @Newaction => m_Wrapper.m_XRILeftHandController_Newaction;
